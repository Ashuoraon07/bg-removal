...
const Testimonials = () => {
  return (
    <div>
     ...
     bg-clip-text text-transparent leading-relaxed py-5'>Customer Testimonials</h1> 
     ...
     <div className='grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto px-4 py-8'>
        {testimonialsData.map((item,index)=>(
            <div className='bg-white rounded-xl p-6 drop-shadow-md max-w-lg m-auto hover:scale-105 transition-all duration-700' key={index}>
                <p className='text-4xl text-grey-500'>❞</p>
                <p  className='text-sm text-grey-500'>{item.text}</p>

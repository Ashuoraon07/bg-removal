  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div >
            ...
            <p className='my-6 text-[15px] text-gray-500'>Lorem lpsum is simple dummy text of the printing and typesetting industry.<br className='max-sm:hidden'/>Lorem lpsum has been the industry's standard dummy text ever</p>
            <div>

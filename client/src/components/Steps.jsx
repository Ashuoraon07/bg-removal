...
const Steps = () => {
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
     ...
     bg-clip-text text-transparent leading-relaxed'>Steps to remove background <br/> image in seconds</h1>
    
     <div className='flex items-start flex-wrap gap-4 mt-15 xl:mt-24 justify-center'>
